<template>
  <div class="home page">
    ...
    <!-- <mt-swipe :auto="3000" class="swiper">
      <mt-swipe-item v-for="(item, index) in swipe_img_list" :key="index" class="swiper-item">
        <img :src="item.url" />
      </mt-swipe-item>
    </mt-swipe>-->
    <!-- 科目选择 -->
